...
import { IBlogPostPopulated } from '../models/blog-post.model';

export default function Editor({ post }: { post: IBlogPostPopulated }) {
  let [isPendingSaving, startTransitionSaving] = useTransition();
  let [isPendingPublishing, startTransitionPublishing] = useTransition();
  const [data, setData] = useState<IBlogPostPopulated>(post);
