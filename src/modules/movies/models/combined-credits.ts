import { MovieWithMediaType, TvSeriesWithMediaType } from '.';
...
export type RawTvSeriesCredit = TvSeriesWithMediaType & {
  character: string;
};

export type RawCombinedCredit = RawMovieCredit | RawTvSeriesCredit;
