...
import { Spinner } from '@/modules/ai-search/components/ui/spinner';
import { Section } from '@/modules/ai-search/components/section';
import { FollowupPanel } from '@/modules/ai-search/components/followup-panel';
import {
  inquire,
  researcher,
  taskManager,
  querySuggestor,
} from '@/modules/ai-search/lib/agents';
import { writer } from '@/modules/ai-search/lib/agents/writer';
import { saveChat } from '@/modules/ai-search/lib/actions/chat';
import { AIMessage, Chat } from '@/modules/ai-search/lib/types';
import { UserMessage } from '@/modules/ai-search/components/user-message';
import { BotMessage } from '@/modules/ai-search/components/message';
import { SearchSection } from '@/modules/ai-search/components/search-section';
import SearchRelated from '@/modules/ai-search/components/search-related';
import { CopilotDisplay } from '@/modules/ai-search/components/copilot-display';
...
export const AI = createAI<AIState, UIState>({
  ...
  onSetAIState: async ({ state, done }) => {
    ...
    const path = `/ai-search/search/${chatId}`;
    const title =
      messages.length > 0
        ? // @ts-ignore
